...
// Main CTA Section for homepage - Combined with Newsletter
      ...
      <div className="container-custom text-center">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-12 max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-white mb-4">
            Verpassen Sie keine Steuertipps mehr!
          </h3>
          <p className="text-white/90 mb-6">
            Erhalten Sie monatlich wertvolle Steuerratschläge und Updates zu Gesetzesänderungen direkt in Ihr Postfach.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
            <input
              type="email"
              placeholder="Ihre E-Mail-Adresse"
              className="flex-1 px-4 py-3 rounded-lg text-neutral-900 border-0 focus:ring-2 focus:ring-white"
            />
            <button className="bg-white text-brand-blue px-6 py-3 rounded-lg font-semibold hover:bg-neutral-50 transition-colors whitespace-nowrap">
              Anmelden
            </button>
          </div>
          <p className="text-sm text-white/70 mt-4">
            Kostenlos und jederzeit kündbar. Über 15.000 Abonnenten vertrauen uns bereits.
          </p>
        </div>
