        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-1 gap-16 lg:gap-20 items-center">
            ...
            <div className="space-y-10 lg:w-1/2 lg:pr-20">
              {/* Trust Badge */}
              <div className="inline-flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-full border border-slate-200 mt-8">
              ...
              <div className="grid sm:grid-cols-3 gap-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900 whitespace-nowrap">100% Kostenlos</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center">
            ...
            {/* Right Column - Hero Image/Visual - Hidden on large screens */}
            <div className="relative lg:hidden">
              <div className="relative">
                ...
                <div className="absolute top-60 -right-6 bg-white/97 backdrop-blur-md rounded-xl shadow-sm p-5 border border-white/40">
