...
const translations = {
  de: {
    ...
    'hero.title_highlight': 'Wir haben die perfekte Lösung!',
  ...
  en: {
    ...
    'hero.title_highlight': 'We have it solved!',
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const t = (key: string): string => {
    try {
      ...
      const translation = languageTranslations[key as keyof typeof translations['de']];
      if (!translation) {
